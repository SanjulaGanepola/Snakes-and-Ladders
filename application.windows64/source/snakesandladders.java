...
public class snakesandladders extends PApplet {

public void setup() { // define a reference to an image object  void setup(){
  ...
  case 5://Game
    if (game==true) {//The game is currently running
      ...
      case 1:
        ...
        if (mouseX > 652 && mouseX < 712 && mouseY > 504 && mouseY < 564 && mousePressed) {//If mouse is pressed, get a random integer
          ...
          diceroll = PApplet.parseInt(random(dice.length));//Random integer
          delay(100);
    ...
    if (on==false) {//End Game Screen
      ...
      if (mouseX > 80 && mouseX < 380 && mouseY > 460 && mouseY < 535 && mousePressed) {//High Score Button
        ...
        if (score < PApplet.parseInt(winnerscore[0])) {//Check if the new score is less than the current first place score
        ...
        } else if (score < PApplet.parseInt(winnerscore[1])) {//Check if the new score is less than the current second place score
          winnerscore[4]=winnerscore[3];//Move highscore 3 to 4
          winnerscore[3]=winnerscore[2];//Move highscore 2 to 3
          winnerscore[2]=winnerscore[1];//Move highscore 1 to 2
          winnerscore[1]=str(score);//Set new score as second place
        } else if (score < PApplet.parseInt(winnerscore[2])) {//Check if the new score is less than the current third place score
          winnerscore[4]=winnerscore[3];//Move highscore 3 to 4
          winnerscore[3]=winnerscore[2];//Move highscore 2 to 3
          winnerscore[2]=str(score);//Set new score as third place
        } else if (score < PApplet.parseInt(winnerscore[3])) {//Check if the new score is less than the current fourth place score
          winnerscore[4]=winnerscore[3];//Move highscore 3 to 4
          winnerscore[3]=str(score);//Set new score as fourth place
        } else if (score < PApplet.parseInt(winnerscore[4])) {//Check if the new score is less than the current fifth place score
...
//Need to load the MINIM library
...
AudioPlayer endgame;//End of the game sound
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "snakesandladders" };
    if (passedArgs != null) {
